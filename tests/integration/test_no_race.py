...
class TestNoRaceWithLock:
    def test_lock_protected_writes(self):
    ...
    def test_lock_protected_read_and_write(self):
    ...
    def test_rlock_protected_writes(self):
    ...
    def test_multiple_variables_all_protected(self):
...
class TestNoRaceThreadLocal:
    def test_thread_local_objects_never_flagged(self):
    ...
    def test_disjoint_attribute_access(self):
...
class TestNoRaceAfterJoin:
    def test_post_join_access_is_safe(self):
